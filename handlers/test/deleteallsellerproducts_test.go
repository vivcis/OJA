...
func TestDeleteAllSellerProducts(t *testing.T) {
	...
	t.Run("testing for error deleting all seller products", func(t *testing.T) {
		...
		assert.Contains(t, rw.Body.String(), "error deleting all seller products")
	})
	t.Run("testing for success deleting all seller products", func(t *testing.T) {
		...
		assert.Contains(t, rw.Body.String(), "all products deleted successfully")
	})
}
